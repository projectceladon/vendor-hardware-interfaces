...
VirtVehicleHardware::VirtVehicleHardware() {
    ...
    mEmulator = std::make_unique<VehicleVmcu>(this);
    startVehicleBuses();
}
...
void VirtVehicleHardware::startVehicleBuses() {
...
::ndk::ScopedAStatus VirtVehicleHardware::VehicleBusCallback::onNewPropValues(
...
void VirtVehicleHardware::stopVehicleBuses() {
