 ...
 * changed.
 */
void VehicleVmcu::doSetValueFromClient(const VehiclePropValue& propValue) {
    vhal_proto::VmcuMessage msg;
...
void VehicleVmcu::doGetConfig(const VehicleVmcu::VmcuMessage& rxMsg,
                                    VehicleVmcu::VmcuMessage* respMsg) {
...
void VehicleVmcu::doGetConfigAll(const VehicleVmcu::VmcuMessage& /* rxMsg */,
                                     VehicleVmcu::VmcuMessage* respMsg) {
...
void VehicleVmcu::doGetProperty(const VehicleVmcu::VmcuMessage& rxMsg,
                                    VehicleVmcu::VmcuMessage* respMsg) {
...
void VehicleVmcu::doGetPropertyAll(const VehicleVmcu::VmcuMessage& /* rxMsg */,
                                         VehicleVmcu::VmcuMessage* respMsg) {
...
void VehicleVmcu::doSetProperty(const VehicleVmcu::VmcuMessage& rxMsg,
                                    VehicleVmcu::VmcuMessage* respMsg) {
...
void VehicleVmcu::doDebug(const vhal_proto::VmcuMessage& rxMsg,
...
void VehicleVmcu::processMessage(const vhal_proto::VmcuMessage& rxMsg,
                                     vhal_proto::VmcuMessage* respMsg) {
...
void VehicleVmcu::populateProtoVehicleConfig(const VehiclePropConfig& cfg,
...
void VehicleVmcu::populateProtoVehiclePropValue(const VehiclePropValue& val,
