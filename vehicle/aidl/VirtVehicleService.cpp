...
#define LOG_TAG "VirtVehicleService"
...
using ::android::hardware::automotive::vehicle::fake::VirtVehicleHardware;
...
int main(int /* argc */, char* /* argv */[]) {
    ...
    std::unique_ptr<VirtVehicleHardware> hardware = std::make_unique<VirtVehicleHardware>();
    std::shared_ptr<DefaultVehicleHal> vhal =
            ::ndk::SharedRefBase::make<DefaultVehicleHal>(std::move(hardware));

    ALOGI("Virtual Vehicle Service: Registering as service...");
    ...
    ALOGI("Virtual Vehicle Service Ready");

    ABinderProcess_joinThreadPool();

    ALOGI("Virtual Vehicle Service Exiting");
