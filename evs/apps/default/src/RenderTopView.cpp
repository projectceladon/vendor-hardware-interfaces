...
bool RenderTopView::activate() {
    ...
    mTexAssets.checkerBoard.reset(
            createTextureFromPng("/system/etc/automotive/evs/LabeledChecker_intel.png"));
    ...
    // Load the car image
    mTexAssets.carTopView.reset(createTextureFromPng("/system/etc/automotive/evs/CarFromTop_intel.png"));
